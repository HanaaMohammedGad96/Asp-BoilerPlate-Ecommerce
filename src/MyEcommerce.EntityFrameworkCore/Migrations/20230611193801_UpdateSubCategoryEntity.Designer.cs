...
namespace MyEcommerce.Migrations
{
    ...
    [Migration("20230611193801_UpdateSubCategoryEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEcommerce.Entities.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyEcommerce.Entities.Categories.CategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEcommerce.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyEcommerce.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyEcommerce.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyEcommerce.Entities.Categories.CategoryTranslation", b =>
                {
                    b.HasOne("MyEcommerce.Entities.Categories.Category", "Core")
            ...
            modelBuilder.Entity("MyEcommerce.Entities.ProductImage", b =>
                {
                    b.HasOne("MyEcommerce.Entities.Product", "Product")
