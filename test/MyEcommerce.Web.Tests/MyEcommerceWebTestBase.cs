...
{
    public abstract class MyEcommerceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyEcommerceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyEcommerceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyEcommerceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyEcommerceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyEcommerceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyEcommerceDbContext, Task<T>> func)
        {
            T result;
